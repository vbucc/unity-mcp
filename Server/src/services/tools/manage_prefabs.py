...
@mcp_for_unity_tool(
    description=(
        ...
        "Actions: get_info, get_hierarchy, create_from_gameobject, modify_contents, get_overrides, revert_overrides, open_prefab_stage, save_prefab_stage, close_prefab_stage. "
        ...
        "source_prefab_path instantiates as nested prefab; primitive_type creates a primitive. They are mutually exclusive. "
